...
import sys
import os
import motorsimulador # Este import agora usará o nosso arquivo falso
...
class App:
    def __init__(self):
        ...
        pygame.display.set_caption("Axiom Robô Vision - Teste PC")
        ...
        try:
            ...
            print("Aviso: 'logo.png' não encontrado. Usando superfícies em branco.")
        ...
        # A chamada para setup_motors() agora usará nosso arquivo mock
    ...
    def quit_app(self):
        ...
        # A chamada de limpeza agora usará nosso arquivo mock
...
class TelaCalibracao:
    ...
    def start(self):
        # MUDANÇA PRINCIPAL: Removido cv2.CAP_V4L2 para compatibilidade
...
class TelaRodada:
    ...
    def visualize_rois(self, display_frame, zone_states):
        ...
        for name, roi in self.ZONAS.items():
            x, y, w, h = roi
            color = (255, 0, 255)
            if zone_states[name] == "Vermelho": color = (0, 0, 255) # Vermelho em BGR
            elif zone_states[name] == "Verde": color = (0, 255, 0)
            elif zone_states[name] == "Preto": color = (255, 0, 0) # Azul em BGR para representar preto
